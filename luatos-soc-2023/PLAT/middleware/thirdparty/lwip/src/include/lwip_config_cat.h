...
#if !defined ENABLE_PSIF_IPV6 || defined __DOXYGEN__
...
#define PS_MM_IMS_UL_MAX_TOTAL_BUFFER_SIZE  16*1024   //used for UL IP PKG, control the total UL pkg buffer, just system dynamic heap memory
...
#if DHCPD_ENABLE_DEFINE     /* defined in: makefile.inc, and enabled by feature ctrl: THIRDPARTY_DHCPD_ENABLE */
...
#define TCPIP_ENABLE_PORT_MGR LWIP_ENABLE_PPP_RNDIS_LAN
...
#define LWIP_ARP                       LWIP_ENABLE_PPP_RNDIS_LAN
#endif
...
#define TCPIP_THREAD_PRIO             osPriorityNormal5     /* In LiteOs: 16, osPriorityNormal5 */
#else
#define TCPIP_THREAD_PRIO             osPriorityNormal7     /* In FreeRTOS: 31, osPriorityNormal7 */
#endif
#endif
