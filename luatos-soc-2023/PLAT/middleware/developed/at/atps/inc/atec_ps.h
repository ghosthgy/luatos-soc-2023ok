...
/* AT+ECEMCATT */
#define ATC_EMCATT_0_STATE_VAL_MIN               0
#define ATC_EMCATT_0_STATE_VAL_MAX               1
#define ATC_EMCATT_0_STATE_VAL_DEFAULT           1  /* attached */
...
#define ATC_CGDCONT_9_PARA_VAL_MAX                  1
...
/* AT+CEVDP */
#define ATC_CEVDP_VAL_MIN                      1
#define ATC_CEVDP_VAL_MAX                      4
#define ATC_CEVDP_VAL_DEFAULT                  4
...
CmsRetId  psCEVDP(const AtCmdInputContext *pAtCmdReq);
...
CmsRetId  psECEMCATT(const AtCmdInputContext *pAtCmdReq);
