...
/*AT+ECPLMNINTERVAL*/
#define ATC_ECPLMNINTERVAL_LEVEL_VAL_MIN        0
#define ATC_ECPLMNINTERVAL_LEVEL_VAL_MAX        4
#define ATC_ECPLMNINTERVAL_LEVEL_VAL_DEFAULT    0
#define ATC_ECPLMNINTERVAL_MAXTIMELEN_VAL_MIN       1
#define ATC_ECPLMNINTERVAL_MAXTIMELEN_VAL_MAX       65535
#define ATC_ECPLMNINTERVAL_MAXTIMELEN_VAL_DEFAULT   65535   /*maxTimeLen, default: 0xFFFF - disable OOS PLMN Guard Timer*/
#define ATC_ECPLMNINTERVAL_INTERVAL_VAL_MIN         1
