...
#define      PS_ENABLE_EMC_BR_FEATURE               /* 718H, enable emergency attach/bearer feature */
#else
#undef       PS_ENABLE_EMC_BR_FEATURE               /* Except 718H, disable emergency attach/bearer feature */
#endif
