...
typedef enum _EPAT_CcioDevExecFlagsTag
{
     ...
     */
    CCIO_DEF_CUST_RSVD_END = 0x0DEFCFFF,

    CCIO_DEF_UNDEF = 0x0DEFFFFF,
    CCIO_DEF_END = CCIO_DEF_UNDEF
}CcioDevExecFlags_e;
...
typedef enum _EPAT_CcioDevStatusFlagsTag
{
    CCIO_DSF_USB_BEGIN = 0x0D5F0000,
    ...
    CCIO_DSF_USB_STATE,
    CCIO_DSF_USB_END = 0x0D5F0FFF,

    CCIO_DSF_UART_BEGIN = 0x0D5F2000,
    CCIO_DSF_AUTO_BAUDRATE,
    CCIO_DSF_WAIT_TX_DONE,
    CCIO_DSF_SET_TX_DONE,
    CCIO_DSF_IPR_FLUSH,
    CCIO_DSF_UART_END = 0x0D5F2FFF,

    CCIO_DSF_RADIO_BEGIN = 0x0D5F4000,
    CCIO_DSF_ULPDU_FREE = CCIO_DSF_RADIO_BEGIN,
    CCIO_DSF_DLPDU_FREE,
    CCIO_DSF_WAN_MEDIA_NOTIF,
    CCIO_DSF_RADIO_END = 0x0D5F4FFF,

    CCIO_DSF_HWIND_BEGIN = 0x0D5F6000,
    CCIO_DSF_DEV_ADD,
    CCIO_DSF_DEV_DEL,
    CCIO_DSF_DEV_ALT,
    CCIO_DSF_CTS_CHG,
    CCIO_DSF_DTR_CHG,
    CCIO_DSF_RI_DONE,
    CCIO_DSF_HWIND_END = 0x0D5F6FFF,

    CCIO_DSF_CUSTOM_BEGIN = 0x0D5FC000,
    /*
     * rsvd for customers
     * refer to 'CcioCustDevStatusFlags_e'
     */
    CCIO_DSF_CUSTOM_END = 0x0D5FCFFF,

    CCIO_DSF_UNDEF = 0x0D5FFFFF,
    CCIO_DSF_END = CCIO_DSF_UNDEF
...
{
    uint8_t  isEnable;
    uint8_t  rmtFlags;   /* CcioRemoteFlags_bm */
    uint16_t devState;
    struct CcioDevice *chdev;
}CcioDsaUsbState_t;
...
typedef int32_t (*chdevUserSetFunc)(void *args, CcioDeaSetStaticConf_t *staticConf);
